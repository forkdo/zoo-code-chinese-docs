---
description: Zoo Code 3.33.0 adds Gemini 3 Pro Preview, improves Gemini defaults and cost reporting, and enables native tool calling for the OpenAI-native provider.
keywords:
  - zoo code 3.33.0
  - new features
  - bug fixes
...
# Zoo Code 3.33.0 Release Notes (2025-11-18)

Gemini 3 Pro Preview is now available in Zoo Code and already performing extremely well in real-world coding tasks, alongside 16 tweaks and fixes—thanks to everyone in the Zoo Code community who helped shape this release.

<img src="/img/v3.33.0/v3.33.0.png" alt="Zoo Code v3.33.0 Release" width="600" />

## Gemini 3 Pro Preview

Zoo Code now supports Google’s Gemini 3 Pro Preview model through direct Gemini, Vertex AI, and aggregator providers like OpenRouter and Requesty ([#9357](https://github.com/RooCodeInc/Roo-Code/pull/9357), [#9327](https://github.com/RooCodeInc/Roo-Code/pull/9327)):
...
- **Strong eval performance**: Achieves a 100% score on internal Zoo Code evals and 76.2% on SWE-bench Verified, giving more consistent solutions on real-world coding tasks.
...
- **Zoo Code Cloud provider pricing page** ([#9195](https://github.com/RooCodeInc/Roo-Code/pull/9195)): Adds a pricing page and related Cloud provider tweaks so pricing is easier to understand before you enable Zoo Code Cloud.
