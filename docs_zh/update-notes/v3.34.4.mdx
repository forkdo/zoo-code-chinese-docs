---
description: This patch release adds free Black Forest Labs image generation models on Zoo Code Cloud and OpenRouter and improves reliability when using native MCP tools with context condensing.
keywords:
  - zoo code 3.34.4
...
# Zoo Code 3.34.4 Release Notes (2025-11-25)

This patch release adds free Black Forest Labs image generation models on Zoo Code Cloud and OpenRouter, and makes native MCP tools more reliable by preserving tool names and tool_use blocks during context condensing.

<img src="/img/v3.34.4/v3.34.4.png" alt="Zoo Code v3.34.4 Release" width="600" />

## Black Forest Labs image generation on Zoo Code Cloud

New Black Forest Labs FLUX.2 models are now wired through Zoo Code’s image pipeline for Zoo Code Cloud image generation ([#9587](https://github.com/RooCodeInc/Roo-Code/pull/9587)):

- **Free image generation on Zoo Code Cloud**: Use the `bfl/flux-2-pro:free` model on Zoo Code Cloud for high-quality image generation without worrying about unexpected image charges.
...
> **📚 Documentation**: See [Image Generation](/features/image-generation) for how to use image generation in Zoo Code. 
