---
description: 浏览所有 Zoo Code 版本发布说明和版本更新。查找每个版本的详细更新日志、新功能、错误修复和改进内容。
keywords:
  - zoo code updates
  - release notes
  - version history
...
如果你想尝鲜体验尚未正式发布的功能，可以使用我们的 [Nightly 频道](https://marketplace.visualstudio.com/items?itemName=ZooCodeOrganization.zoo-code-nightly)。
