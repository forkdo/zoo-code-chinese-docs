---
description: Focused UX, logging, and stability improvements for Zoo Code tasks, providers, and context handling.
keywords:
  - zoo code 3.31.0
  - new features
  - bug fixes
...
# Zoo Code 3.31.0 Release Notes (2025-11-08)

This release refines task and to-do workflows, improves Zoo Code Cloud diagnostics, tightens OpenRouter routing, and delivers key stability fixes for long-running sessions.

<img src="/img/v3.31.0/v3.31.0.png" alt="Zoo Code v3.31.0 Release" width="600" />
...
- **Less caffeinated welcome animation** ([#9104](https://github.com/RooCodeInc/Roo-Code/pull/9104)): Smooths the Zoo hover animation to be less distracting during long sessions while keeping the interface responsive.
...
- Improved Zoo Code Cloud error logging to capture richer context (status codes, response bodies, and request details), making it easier to understand and resolve provider and configuration issues. ([#9098](https://github.com/RooCodeInc/Roo-Code/pull/9098))
