...
# Zoo Code 3.30.2 Release Notes (2025-11-06)
...
<img src="/img/v3.30.2/v3.30.2.png" alt="Zoo Code v3.30.2 Release" width="600" />
...
* Checkpoints always commit to Zoo’s shadow repository even when GIT_DIR is set in Dev Containers, preventing leaks to external repos (thanks heyseth, nonsleepr!) ([#8811](https://github.com/RooCodeInc/Roo-Code/pull/8811))
