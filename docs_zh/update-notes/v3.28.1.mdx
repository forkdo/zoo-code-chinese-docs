---
description: Small patch release with QOL improvements and Zoo Code Cloud announcements.
keywords:
  - roo code 3.28.1
  - qol improvements
  - cloud features
...
# Zoo Code 3.28.1 Release Notes (2025-09-11)

This release adds Zoo Code Cloud integration features, improves conversation condensing, and includes various quality-of-life improvements.

<img src="/img/v3.28.1/v3.28.1.png" alt="Zoo Code v3.28.1 Release" width="600" />
## QOL Improvements
...
* **Cloud Task Button**: Added a new button for opening tasks in Zoo Code Cloud with QR codes and shareable URLs ([#7572](https://github.com/RooCodeInc/Roo-Code/pull/7572))
...
* **Zoo Code Cloud Announcement**: Updated in-app announcements about Zoo Code Cloud features, localized in 18 languages ([#7914](https://github.com/RooCodeInc/Roo-Code/pull/7914))