...
# Zoo Code 3.30.3 Release Notes (2025-11-07)
...
<img src="/img/v3.30.3/v3.30.3.png" alt="Zoo Code v3.30.3 Release" width="600" />
...
- Mode import flow: after importing a mode, Zoo auto‑switches to it; if the mode data hasn’t loaded yet, Zoo briefly falls back to Architect mode to avoid UI desync.
