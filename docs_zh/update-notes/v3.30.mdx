...
# Zoo Code 3.30 Release Notes (2025-11-03)
...
<img src="/img/v3.30.0/v3.30.0.png" alt="Zoo Code v3.30 Release" width="600" />

## OpenRouter Embeddings

We've added OpenRouter as an embedding provider for codebase indexing in Zoo Code (thanks dmarkey!) ([#8973](https://github.com/RooCodeInc/Roo-Code/pull/8973)).
...
* Ensure Checkpoints commit to Zoo’s shadow repository even when GIT_DIR is set in Dev Containers (thanks nonsleepr!) ([#8811](https://github.com/RooCodeInc/Roo-Code/pull/8811))
