---
description: Zoo Code 3.36.9 defaults more providers to native tools, improves reliability for tool calls and MCP schemas, and makes error details easier to debug.
keywords:
  - zoo code 3.36.9
  - native tools
  - mcp
...
# Zoo Code 3.36.9 Release Notes (2025-12-16)
...
<img src="/img/v3.36.9/v3.36.9.png" alt="Zoo Code v3.36.9 Release" width="600" />

## Native tools by default (more providers)

Zoo Code now defaults to the **Native** tool protocol for more providers—so tool use is more consistent out of the box on:
...
* **More complete streaming failure details**: Improves the streaming failure UI so you can view/copy full error details directly in Zoo Code instead of relying on the developer console ([#10131](https://github.com/RooCodeInc/Roo-Code/pull/10131))
