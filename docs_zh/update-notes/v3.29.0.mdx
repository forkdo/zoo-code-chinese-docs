---
description: Intelligent file reading, browser-use on image-capable models, dynamic Zoo Code Cloud model loading, plus fixes and provider updates.
keywords:
  - zoo code 3.29.0
  - new features
  - bug fixes
...
# Zoo Code 3.29.0 Release Notes (2025-10-24)

This release adds intelligent file reading, enables browser-use for all image-capable models, and adds dynamic Zoo Code Cloud model loading — plus many fixes and model updates.

<img src="/img/v3.29.0/v3.29.0.png" alt="Zoo Code v3.29.0 Release" width="600" />

## Introducing Zoo Code's first Cloud Agent, the PR Reviewer

It runs Zoo in the cloud, giving extremely high quality code reviews instantly. We’ve been using it heavily to build Zoo and now it's also available to the community.
...
* Zoo Code Cloud: dynamic model loading in the Model Picker with 5‑minute caching, auth‑state refresh, and graceful fallback to static models on failure ([#8728](https://github.com/RooCodeInc/Roo-Code/pull/8728))
