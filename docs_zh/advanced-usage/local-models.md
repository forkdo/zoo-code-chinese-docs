---
description: 了解如何使用 Ollama 和 LM Studio 在本地 AI 模型上运行 Zoo Code。完整的离线 AI 编程辅助设置指南。
keywords:
  - 本地模型
  - Ollama
  - LM Studio
...
Zoo Code 支持使用 [Ollama](https://ollama.com/) 和 [LM Studio](https://lmstudio.ai/) 在您自己的机器上本地运行语言模型。这提供了几个优势：

*   **隐私：** 您的代码和数据永远不会离开您的计算机。
*   **离线访问：** 即使没有互联网连接，您也可以使用 Zoo Code。
...
*   **"无法建立连接，因为目标机器主动拒绝了它"：** 这通常意味着 Ollama 或 LM Studio 服务器没有运行，或者运行在与 Zoo Code 配置使用的不同端口/地址上。请仔细检查 Base URL 设置。
