---
description: Learn how to effectively communicate with Zoo Code using natural language. Best practices for typing requests, examples, and common pitfalls to avoid.
keywords:
  - Zoo Code requests
  - natural language AI
  - typing commands
...
Zoo Code is designed to understand natural language.  You don't need to use any special commands or syntax to communicate with it.  Just type your request in plain English, as if you were talking to a human developer.

<img src="/img/typing-your-requests/naturally.gif" alt="Example of typing a request in Zoo Code" width="600" />

---

## Effective Request Strategies

Clearly state what you want Zoo Code to do.  Avoid vague or ambiguous language.
