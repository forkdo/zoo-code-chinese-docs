...
# Zoo Code 3.19.5 Release Notes (2025-06-05)
...
*   **Gemini 2.5 Pro Preview**: Fixed a bug where the thinking budget was not being correctly applied, causing errors. Zoo Code will now correctly default to the specified token values when they are not defined in the settings. (thanks cte!) ([#4401](https://github.com/RooCodeInc/Roo-Code/pull/4401))
