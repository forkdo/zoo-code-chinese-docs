---
description: Zoo Code 3.11.11 fixes UI highlighting, adds Host header support for OpenAI providers, improves parsers, and adds o1-pro support.
keywords:
  - zoo code
  - v3.11.11
  - release notes
...
# Zoo Code 3.11.11 Release Notes (2025-04-09)
...
*   Focus Zoo Code in the sidebar when running tasks in the sidebar via the API
*   Improve subtasks UI
