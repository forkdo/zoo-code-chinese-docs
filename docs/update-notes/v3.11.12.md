---
description: Zoo Code 3.11.12 enables Grok3 streaming through OpenAI Compatible providers and makes diff editing more tolerant of model errors.
keywords:
  - zoo code
  - v3.11.12
  - release notes
...
# Zoo Code 3.11.12 Release Notes (2025-04-09)
