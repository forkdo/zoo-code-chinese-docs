...
# Zoo Code 3.23.0 Release Notes (2025-07-09)
...
Codebase indexing has graduated from an experimental feature and is now a core part of Zoo Code, available directly from your chat input. You can now manage your index by clicking the database icon in the bottom-right corner of the chat box. Once configured, the indexer runs automatically in the background, ensuring Zoo always has an up-to-date semantic understanding of your project. To get started, see the [Codebase Indexing quick start guide](/features/codebase-indexing#quick-start-guide).
