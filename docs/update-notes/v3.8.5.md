---
description: Zoo Code 3.8.5 features major terminal architecture improvements, MCP over SSE support, remote browser connectivity, and expanded provider capabilities.
keywords:
  - zoo code 3.8.5
  - terminal refactor
  - mcp sse
...
# Zoo Code 3.8.5 Release Notes (2025-03-12)
