---
description: Zoo Code 3.11.10 fixes nested .roo/rules directories, OpenAI provider caching, and improves command output handling and translations.
keywords:
  - zoo code
  - v3.11.10
  - release notes
...
# Zoo Code 3.11.10 Release Notes (2025-04-08)
