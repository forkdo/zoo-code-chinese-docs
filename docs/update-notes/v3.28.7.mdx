---
description: Zoo Code 3.28.7 adds a Cloud account switcher, improves conversation readability with collapsible thinking blocks, fixes a checkpoint popover issue, and updates the Chutes provider.
keywords:
  - zoo code 3.28.7
...
# Zoo Code 3.28.7 Release Notes (2025-09-23)
...
<img src="/img/v3.28.7/v3.28.7.png" alt="Zoo Code v3.28.7 Release" width="600" />
## QOL Improvements
