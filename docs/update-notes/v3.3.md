---
description: Zoo Code 3.3 brings VS Code code actions, mode switching, Debug mode, experimental checkpoints, @terminal mentions, enhanced Markdown editing, and extensive provider updates.
keywords:
  - zoo code 3.3
  - code actions
  - debug mode
...
# Zoo Code 3.3 Release Notes (2025-02-27)
...
*   **New Task Tool:** Added a `new_task` tool that allows Zoo to start new tasks with an initial message and mode.
...
*   New Zoo Code community Discord.
