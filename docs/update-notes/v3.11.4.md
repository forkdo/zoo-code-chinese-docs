---
description: Zoo Code 3.11.4 adds tree-sitter support for TSX, TypeScript, JSON, and Markdown, fixes Windows unit tests, improves UI elements, and enhances provider support.
keywords:
  - zoo code 3.11.4
  - tree-sitter
  - tsx support
...
# Zoo Code 3.11.4 Release Notes (2025-04-02)
...
*   Allowed processes to access the Zoo Code API via a unix socket.
