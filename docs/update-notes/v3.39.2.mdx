...
# Zoo Code 3.39.2 Release Notes (2026-01-09)
...
* Improves file-edit reliability for Gemini and Vertex models by disabling the `edit_file` tool for those providers so Zoo Code can route edits through the more appropriate patch-based flow when available ([#10594](https://github.com/RooCodeInc/Roo-Code/pull/10594))
* Improves Gemini tool selection behavior by no longer overriding tool allow/deny lists, letting Zoo Code’s routing decide more consistently ([#10592](https://github.com/RooCodeInc/Roo-Code/pull/10592))

## QOL Improvements

* Adds an **Enable debug mode** toggle in Zoo Code settings (About Zoo Code) so you can turn debug logging on/off from the extension UI ([#10580](https://github.com/RooCodeInc/Roo-Code/pull/10580))
