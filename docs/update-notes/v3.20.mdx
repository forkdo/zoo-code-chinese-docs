---
description: Zoo Code 3.20 introduces the experimental Marketplace for extensions and modes, concurrent file edits and reads, and prompt history navigation.
keywords:
  - Zoo Code 3.20
  - release notes
  - marketplace
...
# Zoo Code 3.20 Release Notes (2025-06-12)
...
**To enable:** Open Zoo Code settings (gear icon) → Experimental Settings → Enable "Marketplace"
...
**To enable:** Open Zoo Code settings (gear icon) → Experimental Settings → Enable "Enable multi-file edits"
