---
description: Zoo Code 3.3.23 patch release fixes issues with unsaved changes on settings page and improves error handling when reading custom instructions from files.
keywords:
  - zoo code 3.3.23
  - settings management
  - unsaved changes
...
# Zoo Code 3.3.23 Release Notes (2025-02-20)
