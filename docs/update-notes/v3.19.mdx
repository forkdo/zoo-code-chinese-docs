---
description: Zoo Code 3.19 focuses on UI improvements with intelligent context condensing enabled by default, enhanced file protection, and experimental multi-file reading.
keywords:
  - Zoo Code 3.19
  - release notes
  - context condensing
...
# Zoo Code 3.19 Release Notes (2025-06-09)
...
*   **Enforce [`codebase_search`](/advanced-usage/available-tools/codebase-search) as primary tool**: Zoo Code now always uses codebase_search as the first step for code understanding tasks, improving accuracy and consistency (thanks hannesrudolph!)
...
Thank you to all our contributors for making Zoo Code better with each release!
