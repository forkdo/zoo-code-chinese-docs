---
description: Zoo Code 3.18 introduces experimental codebase indexing, enhanced context condensing, YAML support for custom modes, and Gemini 2.5 Flash support.
keywords:
  - Zoo Code 3.18
  - release notes
  - codebase indexing
...
# Zoo Code 3.18 Release Notes (2025-05-21)
...
To enhance API cost management, you can now set a **Max Requests** limit for auto-approved actions. This prevents Zoo Code from making an excessive number of consecutive API calls without your re-approval.

<img src="/img/v3.18.0/v3.18.0.png" alt="Setting the Max Requests limit for auto-approved actions in Zoo Code settings." width="600" />
