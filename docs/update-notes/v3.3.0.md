---
description: Zoo Code 3.3.0 introduces native VS Code actions, intelligent mode switching, enhanced Markdown support, and AWS profile configuration for Bedrock provider.
keywords:
  - zoo code 3.3.0
  - code actions
  - mode switching
