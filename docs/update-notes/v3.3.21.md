---
description: Zoo Code 3.3.21 introduces @terminal mention to pull recent terminal output into context, enables o1 model streaming, and fixes language settings and Mistral provider.
keywords:
  - zoo code 3.3.21
  - terminal mention
  - o1 streaming
...
# Zoo Code 3.3.21 Release Notes (2025-02-17)
...
*   Fixed the system prompt to ensure Zoo is aware of all available modes.
