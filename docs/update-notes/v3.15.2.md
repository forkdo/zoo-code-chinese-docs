---
description: Zoo Code 3.15.2 enhances Boomerang Orchestrator for secure task automation, improves Mermaid rendering, and adds OpenAI custom URLs.
keywords:
  - zoo code
  - v3.15.2
  - release notes
...
# Zoo Code 3.15.2 Release Notes (2025-05-02)
...
*   Resolved an issue where the chat input box height could jump unexpectedly when resizing the Zoo Code window.
