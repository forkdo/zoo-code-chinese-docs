---
description: Zoo Code 3.39.0 adds image file @mentions, makes provider profiles stick to tasks, and updates key UI labels.
keywords:
  - zoo code 3.39.0
  - image @mentions
  - providers
...
# Zoo Code 3.39.0 Release Notes (2026-01-08)
...
* Fixes an issue where Zoo Code could generate the wrong command chaining syntax on Windows, making suggested terminal commands more likely to work without edits (thanks app/roomote, AlexNek!) ([#10434](https://github.com/RooCodeInc/Roo-Code/pull/10434))
...
* Adds a one-line CLI installer workflow to simplify installing/upgrading the Zoo Code CLI (thanks cte!) ([#10474](https://github.com/RooCodeInc/Roo-Code/pull/10474))
