---
description: Zoo Code 3.1.7 adds support for DeepSeek-R1 models, introduces experimental unified diff algorithm, and fixes API configuration profiles.
keywords:
  - zoo code
  - v3.1.7
  - deepseek-r1
