---
description: Zoo Code 3.12 adds xAI provider support, profile-specific diff settings, keyboard shortcuts for input, and search in dropdowns.
keywords:
  - zoo code
  - v3.12
  - release notes
...
# Zoo Code 3.12 Release Notes (2025-04-16)
