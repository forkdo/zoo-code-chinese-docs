---
description: Zoo Code 3.3.19 fixes file write abort reverting, honors VS Code themes in dialogs, allows clearing default custom instructions, and uses shadow git for checkpoints.
keywords:
  - zoo code 3.3.19
  - file write abort
  - vs code theme
...
# Zoo Code 3.3.19 Release Notes (2025-02-12)
