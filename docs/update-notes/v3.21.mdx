---
description: Zoo Code 3.21 launches the Zoo Marketplace, adds Gemini 2.5 models support, Claude Max subscription integration, and Excel file support.
keywords:
  - Zoo Code 3.21
  - release notes
  - Zoo Marketplace
...
# Zoo Code 3.21 Release Notes

This release launches the Zoo Marketplace, adds support for the latest Gemini 2.5 models, and introduces Excel file support along with numerous improvements and fixes.

## [Zoo Marketplace Launch](/features/marketplace)

We're excited to announce the official launch of the [Zoo Marketplace](/features/marketplace) ([#4788](https://github.com/RooCodeInc/Roo-Code/pull/4788)):

- **Discover Great MCPs and Modes**: Browse and install community-created Model Context Protocol servers and custom modes directly from within Zoo Code
...
The Zoo Marketplace makes it easy to extend Zoo Code's functionality with powerful integrations created by our vibrant community.

## Use Your Claude Max Subscription with Zoo Code

You can now use your Claude Max subscription directly in Zoo Code through our new Claude Code provider (thanks Cline!) ([#4864](https://github.com/RooCodeInc/Roo-Code/pull/4864), [#5038](https://github.com/RooCodeInc/Roo-Code/pull/5038)):

- **Leverage Your Existing Subscription**: Connect your Claude Max plan to Zoo Code through the Claude CLI
...
- **Seamless Integration**: Works with all existing Zoo Code tools and features
...
* **Marketplace Branding**: Updated to show "Zoo Marketplace" for consistent branding ([#4718](https://github.com/RooCodeInc/Roo-Code/pull/4718))
