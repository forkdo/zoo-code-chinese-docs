---
description: Zoo Code 3.3.2 improves mode configuration with API dropdowns, fixes MCP tools, enhances OpenRouter DeepSeek-R1 support, and refines UI elements.
keywords:
  - zoo code 3.3.2
  - mode configuration
  - openrouter
