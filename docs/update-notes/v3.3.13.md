---
description: Zoo Code 3.3.13 ensures DeepSeek R1 works with Ollama, enables terminal context menus, improves sliding window truncation, and fixes API profile switching bugs.
keywords:
  - zoo code 3.3.13
  - deepseek r1
  - ollama
...
*   Enabled context menu commands (like copy/paste) within the integrated terminal used by Zoo Code. (thanks samhvw8!)
