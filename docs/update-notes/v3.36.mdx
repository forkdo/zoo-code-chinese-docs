---
description: Zoo Code 3.36 introduces non-destructive context management, new debugging and UI controls, and a steady stream of reliability fixes and provider improvements.
keywords:
  - zoo code 3.36
  - release notes
  - new features
...
# Zoo Code 3.36 Release Notes (Combined)

Zoo Code 3.36 introduces non-destructive context management, new debugging and UI controls, and a steady stream of reliability fixes and provider improvements.
...
Zoo Code supports GPT-5.1 Codex Max, OpenAI’s long-horizon coding model, including model defaults for gpt-5.1 / gpt-5 / gpt-5-mini variants ([#9848](https://github.com/RooCodeInc/Roo-Code/pull/9848)).
...
The `gemini-3-flash-preview` model is now available in the Zoo Code Cloud provider, Google Gemini, GCP Vertex AI, Requesty, and OpenRouter providers. It’s the latest model from Google, released this morning (thanks contributors!) ([#10151](https://github.com/RooCodeInc/Roo-Code/pull/10151)).
...
* **Grace Retry for Tool Errors**: When models fail to use tools, Zoo Code now silently retries before showing errors. Clearer "Model Response Incomplete" messages appear only after consecutive failures ([#10196](https://github.com/RooCodeInc/Roo-Code/pull/10196))
...
* **Zoo Code Cloud Model Refresh**: Fixes an issue where authentication-required models (like `google/gemini-3-flash`) wouldn't appear immediately after logging into Zoo Code Cloud ([#10156](https://github.com/RooCodeInc/Roo-Code/pull/10156))
...
* **Workspace task visibility controls for organizations**: Adds an org-level setting for how visible Zoo Code Cloud “extension tasks” are across the workspace ([#10020](https://github.com/RooCodeInc/Roo-Code/pull/10020))
...
* **Reasoning details support (Zoo provider)**: Displays reasoning details from supported models ([#9796](https://github.com/RooCodeInc/Roo-Code/pull/9796))
* **Native tools default (Zoo provider)**: Zoo provider models default to native tool protocol ([#9811](https://github.com/RooCodeInc/Roo-Code/pull/9811))
...
* **Dynamic model settings (Zoo provider)**: Zoo models receive configuration dynamically from the API ([#9852](https://github.com/RooCodeInc/Roo-Code/pull/9852))
