---
description: Zoo Code 3.38 adds Agent Skills and includes follow-up fixes for tool reliability, provider message formatting, and file reading.
keywords:
  - zoo code 3.38
  - new features
  - bug fixes
...
# Zoo Code 3.38 Release Notes (Combined)

Zoo Code 3.38 adds Agent Skills and includes follow-up fixes for tool reliability, provider message formatting, and file reading.
...
* Fixes an issue where Zoo Code’s native `read_file` tool schema didn’t advertise a maximum number of files per call, reducing failed tool calls in environments that enforce low limits ([#10449](https://github.com/RooCodeInc/Roo-Code/pull/10449)).
