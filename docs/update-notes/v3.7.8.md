---
description: Zoo Code 3.7.8 adds GPT-4.5 Preview support, Vertex AI prompt caching for Claude, and advanced custom system prompt capabilities for power users.
keywords:
  - zoo code 3.7.8
  - gpt-4.5 preview
  - vertex ai
...
# Zoo Code 3.7.8 Release Notes (2025-02-27)
