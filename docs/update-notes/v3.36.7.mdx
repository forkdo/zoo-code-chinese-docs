---
description: Zoo Code 3.36.7 simplifies Auto-Approve settings, improves OpenRouter behavior for OpenAI models, and expands Amazon Bedrock options.
keywords:
  - zoo code 3.36.7
  - auto-approve
  - openrouter
...
# Zoo Code 3.36.7 Release Notes (2025-12-15)
...
When you use **OpenAI models via OpenRouter**, Zoo Code now makes tool usage more predictable by explicitly enabling `apply_patch` and avoiding file-writing tools that aren’t supported in that context ([#10082](https://github.com/RooCodeInc/Roo-Code/pull/10082)).
