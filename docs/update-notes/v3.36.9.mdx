...
Zoo now defaults to the **Native** tool protocol for more providers—so tool use is more consistent out of the box on:
...
* **More complete streaming failure details**: Improves the streaming failure UI so you can view/copy full error details directly in Zoo instead of relying on the developer console ([#10131](https://github.com/RooCodeInc/Roo-Code/pull/10131))
