---
description: Zoo Code 3.3.3 patch release enhances error handling for restricted file writes and improves mode/configuration dropdown styling.
keywords:
  - zoo code 3.3.3
  - error handling
  - ui styling
