---
description: Zoo Code 3.15 adds Google Vertex prompt caching, terminal command fallback, enhanced Boomerang mode, and settings import/export.
keywords:
  - zoo code
  - v3.15
  - release notes
...
# Zoo Code 3.15 Release Notes (2025-05-05)
...
*   Zoo Code settings can now be imported directly from the welcome screen (thanks julionav).
...
*   Simplified and streamlined Zoo Code's [quick actions](/features/code-actions).
