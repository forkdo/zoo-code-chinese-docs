...
New Black Forest Labs FLUX.2 models are now wired through Zoo Code’s image pipeline for Roo Code Cloud image generation ([#9587](https://github.com/RooCodeInc/Roo-Code/pull/9587)):
