---
description: Zoo Code 3.11.17 improves OpenAI cache reporting, enhances auto-approve toggles UI, and fixes diff logic and terminal race conditions.
keywords:
  - zoo code
  - v3.11.17
  - release notes
...
# Zoo Code 3.11.17 Release Notes (2025-04-14)
