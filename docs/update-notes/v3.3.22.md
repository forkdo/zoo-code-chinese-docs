---
description: Zoo Code 3.3.22 adds MCP server deletion, wildcard command auto-approval, enhanced provider settings UI, custom language preferences, Catalan support, and Ollama reasoning tags.
keywords:
  - zoo code 3.3.22
  - mcp server delete
...
# Zoo Code 3.3.22 Release Notes (2025-02-20)
