...
# Zoo Code 3.19.0 Release Notes (2025-05-30)
...
*   **Enhanced Sidebar Compatibility**: Menu functionality now remains stable when moving Zoo between primary and secondary sidebars (thanks chrarnoldus!)
