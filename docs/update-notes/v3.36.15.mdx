---
description: Zoo Code 3.36.15 adds a 1M context window option for Claude Sonnet 4.5 on Vertex AI, improves chat error troubleshooting, and expands native tool calling support.
keywords:
  - zoo code 3.36.15
  - vertex ai
  - 1m context
...
# Zoo Code 3.36.15 Release Notes (2025-12-19)
