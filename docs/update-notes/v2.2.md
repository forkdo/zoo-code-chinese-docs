---
description: Zoo Code 2.2 introduces MCP support for custom tools, API configuration profiles, enhanced diff editing, and numerous quality-of-life improvements.
keywords:
  - zoo code
  - v2.2
  - mcp support
...
# Zoo Code 2.2 Release Notes (2025-02-27)
...
*   **Model Context Protocol (MCP) Support (v2.2.0):**
    *   Added support for MCP, enabling Zoo Code to use custom tools like web search or GitHub tools.
    *   Added an MCP server management tab.
    *   Enabled Zoo Code to dynamically create new MCP servers based on user requests.
