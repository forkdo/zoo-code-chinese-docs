---
description: Zoo Code v3.21.0 enhances workspace context awareness by automatically adding the active file to the conversation history. This release also stops Zoo from automatically focusing on the chat input box after a task completes, streamlining user workflow and improving usability.
---

# Zoo Code 3.21.0 Release Notes (2025-06-17)
...
* **Marketplace Branding**: Updated to show "Zoo Marketplace" for consistent branding (thanks @SannidhyaSah!) ([#4718](https://github.com/RooCodeInc/Roo-Code/pull/4718))
