---
description: Zoo Code 3.11.5 adds prompt caching for Amazon Bedrock, configurable MCP server working directories, API profile management, and improved diff editing.
keywords:
  - zoo code 3.11.5
...
# Zoo Code 3.11.5 Release Notes (2025-04-03)
