...
# Zoo Code 3.25.0 Release Notes (2025-07-29)

This release brings powerful new capabilities to Zoo Code, including custom slash commands for workflow automation, enhanced Gemini models with web access, comprehensive image support, and seamless message queueing for uninterrupted conversations.
