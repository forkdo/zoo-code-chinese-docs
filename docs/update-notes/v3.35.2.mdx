...
# Zoo Code 3.35.2 Release Notes (2025-12-01)
...
<img src="/img/v3.35.2/v3.35.2.png" alt="Zoo Code v3.35.2 Release" width="600" />
...
* **Zoo Provider Native Tools**: Models with the `default-native-tools` tag automatically use native tool calling by default for improved tool-based interactions ([#9735](https://github.com/RooCodeInc/Roo-Code/pull/9735))
...
* **App Version Tracking**: The Zoo provider now sends app version information with API requests for improved request tracking and analytics ([#9730](https://github.com/RooCodeInc/Roo-Code/pull/9730))
