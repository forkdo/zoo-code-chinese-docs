---
description: Zoo Code 3.16.0 introduces vertical tab navigation for settings, Groq and Chutes AI providers, clickable code references, and UI/UX enhancements.
keywords:
  - zoo code
  - v3.16.0
  - release notes
...
# Zoo Code 3.16.0 Release Notes

*Release notes for Zoo Code v3.16.0, published on 2025-05-06.*
