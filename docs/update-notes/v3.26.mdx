---
description: Zoo Code v3.26 series - Grok Code Fast, built-in /init command, Qwen Code CLI API support, Vercel AI Gateway integration, and image generation enhancements.
keywords:
  - zoo code 3.26
  - grok code fast
  - init command
...
# Zoo Code 3.26 Release Notes

This document combines all releases in the v3.26 series.

<img src="/img/v3.26.0/v3.26.0.png" alt="Zoo Code v3.26 Release" width="600" />
### Grok Code Fast
...
> **📚 Documentation**: See [xAI Provider](/providers/xai) for direct configuration.
...
- **Mode-Specific Guidance**: Creates tailored documentation for different Zoo Code modes (code, debug, architect, etc.)
...
This opens up new possibilities for task automation, letting the AI leverage the full power of Zoo Code's slash command ecosystem programmatically.
...
We've integrated with the Qwen Code CLI tool, allowing Zoo Code to leverage its free access tier for Alibaba's Qwen3 Coder models ([#7380](https://github.com/RooCodeInc/Roo-Code/pull/7380)):
...
### Kimi K2-0905: Moonshot's Latest Open Source Model is Live in Zoo Code
...
* **MCP Tool Validation**: Zoo now validates MCP tool existence before execution and shows helpful error messages with available tools (thanks R-omk!) ([#7632](https://github.com/RooCodeInc/Roo-Code/pull/7632))
