---
description: Zoo Code 3.3.1 patch release fixes terminal management issues and mode switching bugs for improved stability and performance.
keywords:
  - zoo code 3.3.1
  - terminal management
  - mode switching
