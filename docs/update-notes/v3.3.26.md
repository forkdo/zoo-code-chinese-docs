---
description: Zoo Code 3.3.26 patch release adjusts the default Debug mode prompt to focus on diagnosis and require user confirmation before implementation.
keywords:
  - zoo code 3.3.26
  - debug mode
  - prompt update
...
# Zoo Code 3.3.26 Release Notes (2025-02-27)
