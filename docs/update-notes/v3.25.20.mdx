---
description: This release introduces the Sonic model to Zoo Code users with announcements to help discover the new model.
keywords:
  - zoo code v3.25.20
  - sonic model
  - model announcements
...
# Zoo Code v3.25.20 Release Notes (2025-08-20)

This release introduces the Sonic model to Zoo Code users with announcements to help discover the new model.
