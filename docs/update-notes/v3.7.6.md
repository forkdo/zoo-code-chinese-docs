---
description: Zoo Code 3.7.6 adds multi-file drag-and-drop support, configurable output tokens for thinking models, improves long text handling, and enhances OpenRouter error messages.
keywords:
  - zoo code 3.7.6
...
# Zoo Code 3.7.6 Release Notes (2025-02-26)
