---
description: Zoo Code 3.25.4 adds Doubao and SambaNova providers, introduces context-aware prompt enhancement, and improves tool functionality.
keywords:
  - zoo code 3.25.4
  - doubao provider
  - sambanova provider
...
# Zoo Code 3.25.4 Release Notes (2025-07-31)
...
- **Easy Configuration**: Simple setup through Zoo Code's provider settings with internationalized prompts
...
SambaNova brings enterprise-grade AI infrastructure to Zoo Code, offering alternatives for your development workflows.
