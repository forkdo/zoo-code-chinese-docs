---
description: Zoo Code 3.36.0 introduces non-destructive context management for reliable checkpoint restoration, plus Roo provider enhancements and provider improvements.
keywords:
  - zoo code 3.36.0
  - context condensing
