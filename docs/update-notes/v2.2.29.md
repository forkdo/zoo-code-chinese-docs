---
description: Zoo Code 2.2.29 adds configurable delay after auto-approved file writes, allowing diagnostics and linters time to process.
keywords:
  - zoo code
  - v2.2.29
  - release notes
