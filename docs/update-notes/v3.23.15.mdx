...
* **YouTube Footer**: Quick access to Zoo Code's YouTube channel from the website (thanks thill2323!) ([#5929](https://github.com/RooCodeInc/Roo-Code/pull/5929))
* **PR Templates**: Issue-fixer mode now uses the official Zoo Code PR template (thanks MuriloFP!) ([#5839](https://github.com/RooCodeInc/Roo-Code/pull/5839))
