---
description: Zoo Code 2.2.33 introduces Enhance Prompt feature for OpenRouter models and adds model listing for OpenAI-compatible providers.
keywords:
  - zoo code
  - v2.2.33
  - release notes
