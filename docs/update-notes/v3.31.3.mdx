...
# Zoo Code 3.31.3 Release Notes (2025-11-13)
...
<img src="/img/v3.31.3/v3.31.3.png" alt="Zoo Code v3.31.3 Release" width="600" />
...
* Zoo Anthropic token normalization: Prevents double-counting cached tokens so usage metrics, cost estimates, and context calculations are accurate across providers ([#9224](https://github.com/RooCodeInc/Roo-Code/pull/9224))
