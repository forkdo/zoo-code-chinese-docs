---
description: Zoo Code 3.11.15 adds workspace-based task history filtering, package.json localization, and Anthropic Authorization header support.
keywords:
  - zoo code
  - v3.11.15
  - release notes
...
# Zoo Code 3.11.15 Release Notes (2025-04-13)
