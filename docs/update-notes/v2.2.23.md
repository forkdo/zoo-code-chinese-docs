---
description: Zoo Code 2.2.23 corrects context window size information for gemini-2.0-flash-thinking-exp-1219 model for accurate usage.
keywords:
  - zoo code
  - v2.2.23
  - release notes
