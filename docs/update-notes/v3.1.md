---
description: Zoo Code 3.1 brings customizable chat mode prompts, DeepSeek-R1 support, Mistral provider, auto-approve chat bar, and numerous improvements.
keywords:
  - zoo code
  - v3.1
  - customizable modes
...
# Zoo Code 3.1 Release Notes (2025-02-27)
