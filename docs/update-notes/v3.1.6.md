---
description: Zoo Code 3.1.6 adds support for the Mistral provider and fixes a bug with saving VSCode Language Models configuration profiles.
keywords:
  - zoo code
  - v3.1.6
  - mistral provider
