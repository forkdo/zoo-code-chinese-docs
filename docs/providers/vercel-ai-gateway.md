---
description: Configure the Vercel AI Gateway in Zoo Code to robustly access 100+ language models from various providers through a centralized interface.
keywords:
  - zoo code
  - vercel ai gateway
  - ai provider
...
# Using Vercel AI Gateway With Zoo Code
...
Zoo Code automatically fetches all available models from Vercel AI Gateway's API (hundreds of models from various providers).
