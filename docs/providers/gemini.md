...
description: Use Google's Gemini AI models with Zoo Code. Configure Gemini Flash, Pro, and experimental models for your development workflow.
keywords:
  - google gemini
  - gemini ai
  - zoo code
...
# Using Google Gemini With Zoo Code

Zoo Code supports Google's Gemini family of models through the Google AI Gemini API.
...
Gemini models can now access and analyze web content directly through URL context. This feature allows Zoo to:
