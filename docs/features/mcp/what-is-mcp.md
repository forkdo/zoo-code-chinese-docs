...
Zoo Code implements the Model Context Protocol to:
...
- [Using MCP in Zoo Code](/features/mcp/using-mcp-in-roo) - Get started with MCP in Zoo, including creating simple servers
