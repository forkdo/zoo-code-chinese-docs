...
## Why Zoo Code Uses MCP

Zoo Code leverages MCP to provide:
...
MCP creates a universal connector between Zoo Code and external services, with REST APIs often powering those services behind the scenes.
