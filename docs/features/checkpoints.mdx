---
description: Learn how to use checkpoints in Zoo Code to save your progress, revert changes, and manage your coding workflow with confidence.
keywords:
  - checkpoints
  - save progress
  - version control
...
Checkpoints automatically version your workspace files during Zoo Code tasks, enabling non-destructive exploration of AI suggestions and easy recovery from unwanted changes.
...
Access checkpoint settings in Zoo Code settings under the "Checkpoints" section:
...
2. Configure checkpoint behavior:
   ...
   <img src="/img/checkpoints/checkpoints.png" alt="Checkpoint settings in Zoo Code configuration" width="500" />
...
- **Scope**: Checkpoints only capture changes made during active Zoo Code tasks
...
When restoration executes, Zoo Code:
